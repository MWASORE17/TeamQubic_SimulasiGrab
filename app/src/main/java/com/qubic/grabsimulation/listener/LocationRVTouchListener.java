...
public class LocationRVTouchListener implements RecyclerView.OnItemTouchListener {
    ...
    public LocationRVTouchListener(Context context, final RecyclerView recyclerView, ClickListener listener) {
        mListener = listener;
